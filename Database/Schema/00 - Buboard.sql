...
CREATE TABLE `buboard-data`.`buboard_profiles` ( `profile_id` INT NOT NULL AUTO_INCREMENT , `real_name` VARCHAR(255) NOT NULL , `date_signup` DATETIME NOT NULL , `email_address` VARCHAR(320) NOT NULL , `email_is_confirmed` TINYINT(1) NOT NULL , `profile_desc` VARCHAR(255) NOT NULL , `has_submitted_photo` TINYINT(1) NOT NULL , PRIMARY KEY (`profile_id`));
