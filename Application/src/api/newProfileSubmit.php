...
if ($password1 === $password2) {
    ...
    http://192.168.99.100/api/emailConfirm.php?email=$email&confirmcode=$confirmcode
    ";
    ...
    try {
        ...
        $mail->Username = 'buboard01@gmail.com';                 // SMTP username
        $mail->Password = 'buboardpassword';                           // SMTP password
